...
public class MainActivity extends AppCompatActivity {
    ...
    private List<Note> loadNotesFromDatabase() {
        ...
        while (cursor.moveToNext()) {
            ...
            String date = cursor.getString(cursor.getColumnIndex(TodoEntry.COLUMN_DATE));
            ...
            Log.i(TAG, "itemId:" + itemId + ", Content:" + content + ", Date:" + date+", State:"+state+", Priority: "+priority);
